...
const oneOneFee = (): SubtestQtumSignTransaction => {
...
const oneTwoFee = (): SubtestQtumSignTransaction => {
...
const oneThreeFee = (): SubtestQtumSignTransaction => {
    // See tx d5f65ee80147b4bcc70b75e4bbf2d7382021b871bd8867ef8fa525ef50864882
    const testPayloads: Array<TestQtumSignTransactionPayload> = [
        {
            method: 'qtumSignTransaction',
...
const twoTwo = (): SubtestQtumSignTransaction => {
...
const testnetOneTwoFee = (): SubtestQtumSignTransaction => {
...
const testnetFeeTooHigh = (): SubtestQtumSignTransaction => {
...
const lotsOfOutputs = (): SubtestQtumSignTransaction => {
...
const feeTooHigh = (): SubtestQtumSignTransaction => {
...
const notEnoughFunds = (): SubtestQtumSignTransaction => {
    // See tx d5f65ee80147b4bcc70b75e4bbf2d7382021b871bd8867ef8fa525ef50864882
    const testPayloads: Array<TestQtumSignTransactionPayload> = [
        {
            method: 'qtumSignTransaction',
...
const spendCoinbase = (): SubtestQtumSignTransaction => {
